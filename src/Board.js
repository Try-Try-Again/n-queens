 ...
 */
    ...
    hasAnyRowConflicts: function() {
      for (var i = 0; i < this.get('n').length; i++) {
        var counter = 0;
        //counter
        //iteratring over each column (column is j) // elem in that row
        for (var j = 0; j < this.get('n').length; j++) {
          if (this.get(i)[j] === 1) {
            counter++;
          }
        }
    ...
    hasColConflictAt: function(colIndex) {
        var counter = 0;
      for (var i = colIndex; i < this.get('n').length; i++) {
